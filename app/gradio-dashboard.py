...
raw_documents = TextLoader("tagged_description_Updated.txt", encoding="utf-8").load()

text = raw_documents[0].page_content

documents = [
    Document(page_content=line, metadata={"Source: tagged_description_Updated.txt --> Description_Row":i})
